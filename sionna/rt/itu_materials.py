...
def instantiate_itu_materials(dtype):
    ...
    rm = RadioMaterial(
        "vacuum", frequency_update_callback=vacuum_properties, dtype=dtype
    )
    scene.Scene().add(rm)
    ...
    rm = RadioMaterial(
        "itu_concrete", frequency_update_callback=concrete_properties, dtype=dtype
    )
    scene.Scene().add(rm)
    ...
    # Materials parameters will be updated when the frequency is set
    rm = RadioMaterial(
        "itu_brick", frequency_update_callback=brick_properties, dtype=dtype
    )
    scene.Scene().add(rm)
    ...
    # Materials parameters will be updated when the frequency is set
    rm = RadioMaterial(
        "itu_wood", frequency_update_callback=wood_properties, dtype=dtype
    )
    scene.Scene().add(rm)
    ...
    # Materials parameters will be updated when the frequency is set
    rm = RadioMaterial(
        "itu_glass", frequency_update_callback=glass_properties, dtype=dtype
    )
    scene.Scene().add(rm)
    ...
    # Materials parameters will be updated when the frequency is set
    rm = RadioMaterial(
        "itu_chipboard", frequency_update_callback=chipboard_properties, dtype=dtype
    )
    scene.Scene().add(rm)
    ...
    # Materials parameters will be updated when the frequency is set
    rm = RadioMaterial(
        "itu_plywood", frequency_update_callback=plywood_properties, dtype=dtype
    )
    scene.Scene().add(rm)
    ...
    # Materials parameters will be updated when the frequency is set
    rm = RadioMaterial(
        "itu_marble", frequency_update_callback=marble_properties, dtype=dtype
    )
    scene.Scene().add(rm)
    ...
    # Materials parameters will be updated when the frequency is set
    rm = RadioMaterial(
        "itu_floorboard", frequency_update_callback=floorboard_properties, dtype=dtype
    )
    scene.Scene().add(rm)
    ...
    # Materials parameters will be updated when the frequency is set
    rm = RadioMaterial(
        "itu_metal", frequency_update_callback=metal_properties, dtype=dtype
    )
    scene.Scene().add(rm)
    ...
    # Materials parameters will be updated when the frequency is set
    rm = RadioMaterial(
        "itu_wet_ground", frequency_update_callback=wet_ground_properties, dtype=dtype
    )
    scene.Scene().add(rm)
